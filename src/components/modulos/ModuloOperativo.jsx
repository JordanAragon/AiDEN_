...
const MODULOS = {
  ...
  calidad: {
    ...
    campos: [{id:"codigo",label:"Código",type:"text"},{id:"lote",label:"Lote",type:"text"},{id:"prioridad",label:"Prioridad",type:"select",options:["Baja","Media","Alta"]},{id:"descripcion",label:"Descripción",type:"textarea"},{id:"responsable",label:"Responsable",type:"text"},{id:"estadoManual",label:"Estado",type:"select",options:["Abierta","En revisión","Cerrada"]}],
  ...
  personal: {
    ...
    campos: [{id:"nombre",label:"Nombre completo",type:"text"},{id:"cargo",label:"Cargo",type:"select",options:["Administrador","Supervisor","Operario"]},{id:"contacto",label:"Contacto",type:"text"},{id:"actividades",label:"Actividades asignadas",type:"number"},{id:"estadoManual",label:"Estado",type:"select",options:["Activo","Pendiente","Inactivo"]}],
    ...
    estado: r => r.estadoManual || "Activo", buscar: r => [r.nombre,r.cargo,r.contacto,r.estadoManual].join(" ")
  },
  reportes: {
    etiqueta: "Sistema", titulo: "Reportes", descripcion: "Revisa información consolidada de la operación y prepara consultas por periodo.", boton: "Crear consulta",
    columnas: ["Reporte", "Área", "Periodo", "Estado", "Formato"],
    campos: [{id:"nombre",label:"Nombre del reporte",type:"text"},{id:"area",label:"Área",type:"select",options:["Producción","Inventario","Calidad","Ambiental","Costos","Personal"]},{id:"periodo",label:"Periodo",type:"text"},{id:"estadoManual",label:"Estado",type:"select",options:["Disponible","Programado","Archivado"]},{id:"formato",label:"Formato",type:"select",options:["Pantalla","PDF","Excel"]}],
    iniciales: [{id:"REP-001",nombre:"Producción por lote",area:"Producción",periodo:"Septiembre 2026",estadoManual:"Disponible",formato:"Pantalla"},{id:"REP-002",nombre:"Costos por lote",area:"Costos",periodo:"Septiembre 2026",estadoManual:"Disponible",formato:"Excel"},{id:"REP-003",nombre:"Incidencias de calidad",area:"Calidad",periodo:"Últimos 30 días",estadoManual:"Disponible",formato:"PDF"},{id:"REP-004",nombre:"Historial ambiental",area:"Ambiental",periodo:"Semana actual",estadoManual:"Programado",formato:"Pantalla"}],
    estado: r => r.estadoManual || "Disponible", buscar: r => [r.nombre,r.area,r.periodo,r.estadoManual,r.formato].join(" ")
  },
  configuracion: {
    etiqueta: "Sistema", titulo: "Configuración", descripcion: "Administra preferencias de la cuenta, roles y reglas generales del sistema.", boton: "Nueva regla",
    columnas: ["Parámetro", "Categoría", "Valor", "Alcance", "Estado"],
    campos: [{id:"nombre",label:"Parámetro",type:"text"},{id:"categoria",label:"Categoría",type:"select",options:["Notificaciones","Inventario","Producción","Calidad","Seguridad"]},{id:"valor",label:"Valor",type:"text"},{id:"alcance",label:"Alcance",type:"select",options:["Global","Administradores","Supervisores","Operarios"]},{id:"estadoManual",label:"Estado",type:"select",options:["Activo","Inactivo"]}],
    iniciales: [{id:"CFG-001",nombre:"Alertas de inventario",categoria:"Inventario",valor:"Activadas",alcance:"Global",estadoManual:"Activo"},{id:"CFG-002",nombre:"Notificaciones de calidad",categoria:"Calidad",valor:"Activadas",alcance:"Supervisores",estadoManual:"Activo"},{id:"CFG-003",nombre:"Control de acceso",categoria:"Seguridad",valor:"Por rol",alcance:"Global",estadoManual:"Activo"},{id:"CFG-004",nombre:"Resumen diario",categoria:"Notificaciones",valor:"08:00",alcance:"Global",estadoManual:"Activo"}],
    estado: r => r.estadoManual || "Activo", buscar: r => [r.nombre,r.categoria,r.valor,r.alcance,r.estadoManual].join(" ")
  }
};
...
export default function ModuloOperativo({ tipo }) {
  const config = MODULOS[tipo] || MODULOS.configuracion;
